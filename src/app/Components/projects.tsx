...
const Project = ({ project, handleShowModal }: { project: ProjectType, handleShowModal: (project: ProjectType) => void }) => {
    return (
        <motion.div
            ...
            key={project.id}
            className="flex flex-col flex-shrink-0 bg-neutral-800 max-w-[30rem] max-h-[55rem] overflow-hidden border border-neutral-400 rounded-md cursor-pointer hover:border-purple-900"
        >
            <div>
                <Image
